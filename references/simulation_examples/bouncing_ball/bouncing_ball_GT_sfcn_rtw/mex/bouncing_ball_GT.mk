...
MODULES                 = bouncing_ball_GT_sf.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/bouncing_ball_GT_sf.mexa64
...
NCSTATES                = 2
COMPUTER                = GLNXA64
BUILDARGS               =  CREATEMODEL=1 USEPARAMVALUES=0 OPTS="-DTID01EQ=1"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2024b/bin/glnxa64" -lut -lfixedpoint -lmx -lmex
...
MODELLIB                  = bouncing_ball_GT_sf.mexa64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/bouncing_ball_GT_sfcn_rtw \
...
bouncing_ball_GT_sf.o : $(START_DIR)/bouncing_ball_GT_sfcn_rtw/bouncing_ball_GT_sf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/bouncing_ball_GT_sfcn_rtw/bouncing_ball_GT_sf.c

rtGetInf.o : $(START_DIR)/bouncing_ball_GT_sfcn_rtw/rtGetInf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/bouncing_ball_GT_sfcn_rtw/rtGetInf.c

rtGetNaN.o : $(START_DIR)/bouncing_ball_GT_sfcn_rtw/rtGetNaN.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/bouncing_ball_GT_sfcn_rtw/rtGetNaN.c
