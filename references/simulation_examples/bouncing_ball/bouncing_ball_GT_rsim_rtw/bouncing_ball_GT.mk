...
MAKECMD         = /usr/local/MATLAB/R2024b/bin/glnxa64/gmake -j 10 -l 10
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = bouncing_ball_GT
MODULES                 = rt_logging.c bouncing_ball_GT.c bouncing_ball_GT_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c rt_sim.c ode3.c
...
NCSTATES                = 2
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/usr/local/MATLAB/R2024b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DRT -DRSIM_PARAMETER_LOADING -DTID01EQ=1 -Wno-cast-function-type"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2024b/bin/glnxa64" -lmat -lmx -lut -lmwsl_fileio -lmwsl_simtarget_instrumentation -lmwsigstream -lmwsl_AsyncioQueue -lmwfoundation_i18n_init_c_api -lmwsf_runtime
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/bouncing_ball_GT_rsim_rtw \
...
rsim_main.o : $(MATLAB_ROOT)/rtw/c/rsim/rsim_main.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/rtw/c/rsim/rsim_main.c

rsim_sup.o : $(MATLAB_ROOT)/rtw/c/rsim/rsim_sup.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/rtw/c/rsim/rsim_sup.c

rsim_mat.o : $(MATLAB_ROOT)/rtw/c/rsim/rsim_mat.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/rtw/c/rsim/rsim_mat.c
...
rsim_utils.o : $(MATLAB_ROOT)/rtw/c/src/rapid/rsim_utils.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/rtw/c/src/rapid/rsim_utils.c
...
rt_sim.o : $(MATLAB_ROOT)/rtw/c/src/rt_sim.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/rtw/c/src/rt_sim.c
